...
SUCCESS_MESSAGES = {
    ...
    'RESOURCE_CREATE_SUCCESS': '資源創建成功',
    'RESOURCE_UPDATE_SUCCESS': '資源更新成功',
    'RESOURCE_DELETE_SUCCESS': '資源刪除成功',
    'RESOURCE_BATCH_DELETE_SUCCESS': '批次刪除{count}個資源成功',
...
ERROR_MESSAGES = {
    ...
    # 認證相關錯誤
    'INVALID_CREDENTIALS': '使用者名稱和密碼不能為空',
    'USER_NOT_FOUND': '使用者名稱不存在',
    ...
    'USERNAME_FORMAT_INVALID': '使用者名稱格式不正確，只能包含字母、數字、下劃線和連字號，長度3-50位',

    # 實驗室相關錯誤
    'LAB_NOT_FOUND': '實驗室不存在',
    'LAB_SETUP_REQUIRED': '請先設置實驗室資訊',
    ...
    'MEMBER_UPDATE_NO_FIELDS': '請指定要更新的欄位',
    ...
    'BATCH_UPDATE_NOT_ALLOWED': '欄位 {field} 不允許批次更新',
    ...
    'RESOURCE_NAME_ZH_REQUIRED': '資源中文名稱不能為空',
    'RESOURCE_CREATE_FAILED': '創建資源失敗',
    'RESOURCE_UPDATE_FAILED': '更新資源失敗',
    'RESOURCE_DELETE_FAILED': '刪除資源失敗',
    'RESOURCE_FETCH_FAILED': '獲取資源失敗',
    'RESOURCE_BATCH_DELETE_FAILED': '批次刪除資源失敗',
    'RESOURCE_SELECT_REQUIRED': '請選擇要刪除的資源',
    'IMAGE_UPLOAD_FAILED': '圖片上傳失敗',

    # 管理員相關錯誤
    'ADMIN_NOT_FOUND': '管理員不存在',
    'CANNOT_MODIFY_SELF': '不能修改自己的帳戶',
    'CANNOT_MODIFY_SUPER_ADMIN': '不能修改其他超級管理員的帳戶',
    'CANNOT_DELETE_SELF': '不能刪除自己的帳戶',
    'CANNOT_DELETE_SUPER_ADMIN': '不能刪除其他超級管理員的帳戶',
    'CANNOT_RESET_OWN_PASSWORD': '不能重設自己的密碼，請使用修改密碼功能',
    'CANNOT_RESET_SUPER_ADMIN_PASSWORD': '不能重設其他超級管理員的密碼',
    ...
    'FILE_SIZE_EXCEEDED': '檔案大小超過限制: {max_size} bytes',
    ...
    # 數據校驗錯誤
    'EMAIL_FORMAT_INVALID': '信箱格式不正確',
    'FIELD_LENGTH_EXCEEDED': '{field} 長度不能超過{max_length}字元',
